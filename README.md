...
Live vote counting
Smart contract based system (no database)
...
🚀 How it works
Contract is deployed on Remix VM
Tasks are added using addTask()
Tasks are updated using toggleTask()
Tasks are removed using deleteTask()
Data is read using getTask() and getTaskCount()
